...
public class Game 
{
    ...
    private void createRooms()
    {
        ...
        cellar = new Room("in the cellar room");
        ...
        library.setExits("down", cellar);
        
        cellar.setExits("up", library);

        currentRoom = outside;  // start game outside
        roomStack.add(currentRoom); // initialize room stacks
    }
    ...
    /** 
     * Go back to the room you once were in, using the roomStack to store journeyed rooms.
     */
    private void back(){
        if(roomStack.size() > 1){
