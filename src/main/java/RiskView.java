...
public class RiskView extends JFrame implements RiskModelListener {
    ...
    public ArrayList<JButton> getButtonList() {
        return this.buttonList.getList();
    }
     ...
     */
    public void addPassButtonListener(ActionListener al) {
        this.passButton.addActionListener(al);
    }
    ...
    public void addHelpButtonListener(ActionListener al) {
        this.helpButton.addActionListener(al);
    }
     ...
     */
    public void addAttackButtonListener(ActionListener al) {
        this.attackButton.addActionListener(al);
    }

    /**
     * add fortify button listener
     */
    public void addFortifyButtonListener(ActionListener al) {
        this.fortifyButton.addActionListener(al);
    }
...
class CustomPanel extends JPanel implements RiskModelListener {
    ...
    public void handleRiskModelUpdate(RiskModelUpdateEvent updateEvent) {
        RiskModel model = (RiskModel) updateEvent.getSource();
        if (model.getFileNotFound())
            new JOptionPane().showMessageDialog(this, "No such a saving point is found for this map");
    }
}
